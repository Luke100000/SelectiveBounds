...
public final class Config extends JsonConfig {
    ...
    public String _documentation = "https://github.com/Luke100000/SelectiveBounds/blob/26.1.2/common/src/main/java/net/conczin/selectivebounds/config/Config.java";
